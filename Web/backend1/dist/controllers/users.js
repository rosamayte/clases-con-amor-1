...
var data = JSON.parse(fs_1.default.readFileSync(dir + "/users.json").toString());
exports.createUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, data.push(user)];
            case 1:
                _a.sent();
                return [4 /*yield*/, fs_1.default.writeFileSync(dir + "/users.json", JSON.stringify(data, null, 2))];
            case 2:
                _a.sent();
                return [4 /*yield*/, user];
...
exports.getUser = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, data.findIndex(function (u) { return u.uid === id; })];
            case 1:
                index = _a.sent();
                if (index < 0)
...
exports.updateUser = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0: return [4 /*yield*/, data.findIndex(function (u) { return u.uid === user.uid; })];
            case 1:
                index = _c.sent();
